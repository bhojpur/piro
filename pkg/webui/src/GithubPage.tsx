        ...
        return <React.Fragment>
            <main className={this.props.classes.main}>
                ...
                { isInstallation && <React.Fragment>
                    <Typography>It would appear you have just installed a GitHub app pointing to this Bhojpur Piro installation. To make this installation work you'll need to change the configuration of this installation to include the following:</Typography>
                    <pre>
                    {`
{
