...
import { JobStatus, GetJobRequest, GetJobResponse, LogSliceEvent, ListenRequest, ListenRequestLogs, JobPhase, StopJobRequest, StartFromPreviousJobRequest, SubscribeRequest, FilterExpression, FilterTerm, FilterOp, ListJobsRequest, OrderExpression } from './api/piro_pb';
...
class JobViewImpl extends React.Component<JobViewProps, JobViewState> {
    ...
    async componentDidMount() {
        ...
        document.title = `Bhojpur Piro - ${this.props.jobName}`;
