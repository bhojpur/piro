...
export class StartLocalJobRequest extends jspb.Message {
  ...
  hasApplicationTar(): boolean;
  clearApplicationTar(): void;
  getApplicationTar(): Uint8Array | string;
  getApplicationTar_asU8(): Uint8Array;
  getApplicationTar_asB64(): string;
  setApplicationTar(value: Uint8Array | string): void;

  hasApplicationTarDone(): boolean;
  clearApplicationTarDone(): void;
  getApplicationTarDone(): boolean;
  setApplicationTarDone(value: boolean): void;
...
export namespace StartLocalJobRequest {
  export type AsObject = {
    ...
    applicationTar: Uint8Array | string,
    applicationTarDone: boolean,
  }
