...
func init() {
	proto.RegisterFile("piro-ui.proto", fileDescriptor_8d41ca2a021dc92d)
}
...
func (c *piroUIClient) ListJobSpecs(ctx context.Context, in *ListJobSpecsRequest, opts ...grpc.CallOption) (PiroUI_ListJobSpecsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PiroUI_serviceDesc.Streams[0], "/v1.PiroUI/ListJobSpecs", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedPiroUIServer can be embedded to have forward compatible implementations.
type UnimplementedPiroUIServer struct {
}

func (*UnimplementedPiroUIServer) ListJobSpecs(req *ListJobSpecsRequest, srv PiroUI_ListJobSpecsServer) error {
	return status.Errorf(codes.Unimplemented, "method ListJobSpecs not implemented")
}
func (*UnimplementedPiroUIServer) IsReadOnly(ctx context.Context, req *IsReadOnlyRequest) (*IsReadOnlyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsReadOnly not implemented")
}

func RegisterPiroUIServer(s *grpc.Server, srv PiroUIServer) {
	s.RegisterService(&_PiroUI_serviceDesc, srv)
}
...
var _PiroUI_serviceDesc = grpc.ServiceDesc{
